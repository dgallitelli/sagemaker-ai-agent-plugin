...
|----------|-------------|
| Fine-tune supported model, quick iteration, no infra | Serverless Model Customization (see `references/model-customization.md`) |
| Fine-tune < 7B with custom scripts | Training Jobs |
