#!/usr/bin/env python3
"""
Fine-tune an LLM with LoRA (bf16, no quantization) using SFTTrainer.
...
Use this for LoRA without 4-bit quantization (more memory than QLoRA but higher quality).
For memory-constrained environments, use qlora_peft.py instead.
