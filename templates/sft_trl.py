#!/usr/bin/env python3
"""Full Supervised Fine-Tuning (SFT) using TRL.
...
Full fine-tuning of all model parameters. Requires more memory than LoRA/QLoRA
but can achieve maximum model adaptation for heavy domain shifts.

Requires: transformers, trl, datasets, accelerate
...
def main():
    ...
    print("=" * 60)
    print("Full SFT Training Configuration")
    print("=" * 60)
    ...
    # ==========================================================================
    # Load model (bf16, full parameters)
    # ==========================================================================
    print("Loading model in bf16 for full fine-tuning...")
